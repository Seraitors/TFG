...
INSERT INTO Usuario (username,email ,password,roles)
VALUES ('user','user@wanted.es','user');

INSERT INTO Usuario (username,email ,password,roles)
VALUES ('admin','admin@wanted.es','admin');

INSERT INTO Arco (id, nombre) VALUES (1, 'Wano');

INSERT INTO Arco (id, nombre) VALUES (2, 'Marinforce');

INSERT INTO Arco (id, nombre) VALUES (3, 'Dressrosa');

INSERT INTO Arco (id, nombre) VALUES (4, 'Namek');

INSERT INTO Arco (id, nombre) VALUES (5, 'Tierra');

INSERT INTO Arco (id, nombre) VALUES (6, 'Villa oculta de la Hoja');
